...
def percent(num):
    if stream.lower()=='cse' or stream.lower()=='cseai' or stream.lower()=='cseaiml' or stream.lower()=='cseiotcsbt':
        num=(num*100)//600
...
def remove(string):
    with open(f'{path}/Student.csv','r+',newline='') as f:
        script=csv.reader(f)
...
while message:
    ...
    with open(f'{path}/Department.csv','a',newline='')as f:
        ...
        script.writerow(['CSEAI','Computer Science and Engineering Artificial Intelligence'])
        script.writerow(['CSEAIML','Computer Science and Engineering Artificial Intelligence and Machine Learning'])
        script.writerow(['CSEIOTCSBT','Computer Science and Engineering Internet of Things, Cyber Security and Blockchain Technology'])
        ...
        script.writerow(['EE','Electrical Engineering'])
...
print('\n','Computer Science and Engineering : CSE','\n',
      'Computer Science and Engineering Artificial Intelligence : CSEAI','\n',
      'Computer Science and Engineering Artificial Intelligence and Machine Learning : CSEAIML','\n',
      'Computer Science and Engineering Internet of Things, Cyber Security and Blockchain Technology : CSEIOTCSBT','\n',
